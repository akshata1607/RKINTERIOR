...
<html lang="en">
  <head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>RK Interior Design Studio</title>
  ...
  <body id="bg">
    <div class="page-wraper">
      ...
      <div class="page-content">
          ...
          >
            <ul>
              ...
              <li
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/main-slider/slider3/slide1.jpg","bgFit":"cover","bgPos":"center center","bgRepeat":"no-repeat","direction":"horizontal","easing":"Power2.easeInOut","delay":"500","time":"750","out":"fade","carousel":false}'
              >
                <!-- MAIN IMAGE -->
                <img
                  src="images/main-slider/slider3/slide1-b.jpg"
              ...
              <li
                ...
                data-param10='{"revslider-weather-addon" : { "type" : "" ,"name" : "" ,"woeid" : "" ,"unit" : "" }}'
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/main-slider/slider3/slide2.jpg","bgFit":"cover","bgPos":"center center","bgRepeat":"no-repeat","direction":"horizontal","easing":"Power2.easeInOut","delay":"500","time":"750","out":"fade","carousel":false}'
              >
                <!-- MAIN IMAGE -->
                <img
                  src="images/main-slider/slider3/slide2-b.jpg"
                  data-beforeafter="after"
                  data-bgcolor=""
                  alt=""
                  data-bgposition="center center"
            ...
            <div class="section-content">
              <div class="row">
                <div class="col-lg-5 col-md-12 m-b30 text-uppercase text-black">
                  <span class="font-30 font-weight-300 d-block m-b10"
                    >Welcome</span
                  >
                  <h2 class="font-40">
                  ...
                  <p>
                  RK Interior Design Studio is a dynamic and innovative interior design and architecture startup based in Pune. 
                  Founded in 2024, we are dedicated to crafting stunning spaces that seamlessly blend creativity, functionality, and sustainability.
                  </p>
                  <p class="text-lowercase">
                  Our team of experienced architects, designers, and project managers brings a diverse set of skills and a shared passion for excellence.
                  Whether it’s a cozy home, a vibrant workspace, or a breathtaking commercial design, we collaborate closely with our clients to bring their visions to life.
                  </p>
                  <a
                    href="about-1.php"
                    ...
                    >
                      ...
                      <div class="item">
                        <div class="ow-img wt-img-effect zoom-slow">
                          <a href="about-1.php"
                            ><img src="rkprojectimgs/001.jpg" alt=""
                          /></a>
                        </div>
                      </div>
                      <!-- COLUMNS 2 -->
                      <div class="item">
                        <div class="ow-img wt-img-effect zoom-slow">
                          <a href="about-1.php"
                            ><img src="rkprojectimgs/002.jpeg" alt=""
                          /></a>
                        </div>
                      </div>
                      <!-- COLUMNS 3 -->
                      <div class="item">
                        <div class="owl-img wt-img-effect zoom-slow">
                          <a href="about-1.php"
                            ><img src="rkprojectimgs/006.jpeg" alt=""
                          /></a>
                        </div>
                      </div>
                      <!-- COLUMNS 4 -->
                      <div class="item">
                        <div class="ow-img wt-img-effect zoom-slow">
                          <a href="about-1.php"
                            ><img src="rkprojectimgs/007.jpeg" alt=""
                          /></a>
                        </div>
                      </div>
                      <!-- COLUMNS 5 -->
                      <div class="item">
                        <div class="ow-img wt-img-effect zoom-slow">
                          <a href="about-1.php"
                            ><img src="rkprojectimgs/015.jpeg" alt=""
                          /></a>
                        </div>
                      </div>
                    </div>
        ...
        <div
          class="section-full p-t80 p-lr80 latest_project-outer square_shape3"
        >
          <!-- TITLE START -->
            ...
            <div class="row">
              ...
              <div class="col-xl-7 col-lg-12 col-md-12">
                <ul class="btn-filter-wrap">
                  <li class="btn-filter btn-active" data-filter="*">
                    All Project
                  </li>
                  <li class="btn-filter" data-filter=".building-col">
                    Building
                  </li>
                  <li class="btn-filter" data-filter=".interior-col">
                    Interior
                  </li>
                  <!-- <li class="btn-filter" data-filter=".restaurant-col">
                    Restaurant
                  </li> -->
                </ul>
              </div>
          ...
          <div class="section-content">
            <div class="owl-carousel owl-carousel-filter owl-btn-bottom-left">
                  ...
                  <div class="overlay-bx-2">
                    <div class="line-amiation">
                      <div class="text-white font-weight-300 p-a40">
                        <!-- <h2>
                          <a
                            href="project-detail.php"
                            class="text-white font-20 letter-spacing-4 text-uppercase"
                            >Triangle Concrete House on lake</a
                          >
                        </h2>
                        <p>
                          Morbi mattis ex non urna condimentum, eget eleifend
                          diam molestie. Curabitur lorem enim, maximus non null.
                        </p> -->
                        <a
                          href="project-detail.php"
                          class="v-button letter-spacing-2 font-12 text-lowercase p-l20"
                          >Read More</a
                        >
                      </div>
                    </div>
              ...
              <div class="item fadingcol building-col">
                <div class="wt-img-effect">
                  <img src="rkprojectimgs/008.png" alt="" />
                  <div class="overlay-bx-2">
                    <div class="line-amiation">
                      <div class="text-white font-weight-300 p-a40">
                        <!-- <h2>
              ...
              <div class="item fadingcol interior-col">
                <div class="wt-img-effect">
                  <img src="rkprojectimgs/017.jpg" alt="" />
                  <div class="overlay-bx-2">
                    <div class="line-amiation">
                      <div class="text-white font-weight-300 p-a40">
                        <!-- <h2>
              ...
              <div class="item fadingcol restaurant-col">
                <div class="wt-img-effect">
                  <img src="rkprojectimgs/014.jpeg" alt="" />
                  <div class="overlay-bx-2">
                    <div class="line-amiation">
                      <div class="text-white font-weight-300 p-a40">
                        <!-- <h2>
              ...
              <div class="item fadingcol interior-col">
                <div class="wt-img-effect">
                  <img src="rkprojectimgs/016.jpeg" alt="" />
                  <div class="overlay-bx-2">
                    <div class="line-amiation">
                      <div class="text-white font-weight-300 p-a40">
                        <!-- <h2>
        ...
        <div
          class="section-full p-t140 clearfix bg-repeat tm-wo-we-r"
        ...
        >
              ...
              <div class="row d-flex align-items-center">
                <div class="col-xl-6 col-lg-5 col-md-12">
                  <div class="wt-left-part">
                    <div class="text-uppercase text-black">
                      ...
                      <p>
                      Driven by innovation and passion for design. 
                      Our mission is to craft inspiring spaces that seamlessly combine aesthetics, functionality, and sustainability, turning visionary ideas into reality.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6 col-lg-7 col-md-12">
                  <div class="m-carousel-2">
                    <div
                      class="owl-carousel carousel-hover home-carousel-2 owl-btn-vertical-center"
                    >
                      <!-- COLUMNS 1 -->
                      <div class="item">
                        <div class="wt-box">
                          <div class="ow-img wt-carousel-block gradi-black">
                            ...
                            <div class="p-a50 wt-carousel-info text-white">
                              <div class="carousel-line">
                                <!-- <h2 class="font-28 font-weight-400 m-b10">
                                  New Acropolis Museum
                                </h2>
                                <p class="m-b0">
                                  Mattis ex non urna condimentum, eget eleifend
                                  diam molestie. Curabitur lorem enimnulla sed,
                                  egestas, maximus non nulla sed, egestas
                                  venenatis felis
                                </p> -->
                              </div>
                            </div>
                      ...
                      <div class="item">
                        <div class="wt-box">
                          <div class="ow-img wt-carousel-block gradi-black">
                            <img src="rkprojectimgs/009.jpg" alt="" />
                            <div class="p-a50 wt-carousel-info text-white">
                              <div class="carousel-line">
                                <!-- <h2 class="font-28 font-weight-400 m-b10">
                                  New Acropolis Museum
                      ...
                      <div class="item">
                        <div class="wt-box">
                          <div class="ow-img wt-carousel-block gradi-black">
                            <img src="rkprojectimgs/011.jpeg" alt="" />
                            <div class="p-a50 wt-carousel-info text-white">
                              <div class="carousel-line">
                                <!-- <h2 class="font-28 font-weight-400 m-b10">
                                  New Acropolis Museum
                      ...
                      <div class="item">
                        <div class="wt-box">
                          <div class="ow-img wt-carousel-block gradi-black">
                            <img src="rkprojectimgs/012.jpeg" alt="" />
                            <div class="p-a50 wt-carousel-info text-white">
                              <div class="carousel-line">
                                <!-- <h2 class="font-28 font-weight-400 m-b10">
                                  New Acropolis Museum
          ...
          <div class="container">
            <div
              class="hilite-title p-lr20 m-tb20 text-left text-uppercase bdr-gray bdr-left"
            >
        ...
        <!-- EXPERT & BLOG SECTION HERE -->

        <!-- COMPANY DETAIL SECTION START -->
        <div
          class="section-full p-t80 p-b50 overlay-wraper bg-top-center bg-parallax"
              ...
              <div class="col-lg-6 col-md-12 m-b30">
                <div class="some-facts">
                  <div class="text-white text-uppercase">
                    ...
                    <h2 class="font-50">Intresting Facts</h2>
                    <p class="font-18 font-weight-300">
                    We combine creativity, precision, and sustainability to design impactful spaces that reflect our clients' unique visions, blending art, nature, and functionality with innovative, cutting-edge solutions.
                    </p>
                  </div>
                </div>
              </div>
